...
<body>
	<div id="nav-bar">
		<div>
			<h1>
				<a href="/dashboard" style="text-decoration: none; color: black;">Trip<span
					class="title">Share</span></a>
			</h1>
		</div>
		<div class="friendsearch">
			<input class="friends" type="text" placeholder="search for friends">
			<img class="search-btn" src="/img/icons8-enter-24.png"
				alt="enter icon"> <a href="/logout" id="logout" class="ms-4">Logout</a>
	...
	<div class="container">
		<div class="row">
			<div class="col-sm">
				<br>
				<h2>
					<span style="color: rgb(79, 112, 68); font-weight: 500;"> <c:out
				...
				<div class="card-body text-center">
					<img src=" https://i.imgur.com/d2dKtI7.png" height="100"
						width="100"> <br>
					<form:form action="/leaverating/${location.id}/${trip.id}"
						method="post" modelAttribute="postReview">
						...
						<div class="comment-box text-center">
							...
							<div class="comment-area">
								<form:textarea class="form-control" style="width: 700px;"
									path="content" rows="4"></form:textarea>
							</div>
							<div class="text-center mt-4">
								<button class="btn btn-success send px-5">
									Submit Review <i class="fa fa-long-arrow-right ml-1"></i>
								</button>
							</div>
						</div>
					</form:form>
					<a href="/trip/${trip.id}"><button class="mt-3 btn btn-success">Go
							Back</button></a>
				</div>
										...
										<div class="d-flex justify-content-between mt-2">
											<div class="d-flex flex-row">
												<div class="d-flex flex-column">
													<h6 class="mb-0">${i.user.firstName}
														${i.user.lastName}</h6>
