...
<body>
    ...
    <form:form action="/maketripshare" method="post" modelAttribute="newTripshare">
    <form:hidden path="user" value="${user}"/>
        ...
        <c:if test="${trip.name != null}">
    <h2> Start planning your <span class="fw-bold" style="color:rgb(79, 112, 68)">${trip.name}</span> trip!</h2>
        <div class="row">
        <div class="col-sm">
                ...
                <div class="friend-table">
                    <table class="table-right table table-striped table-light">
                        ...
                        <tr>
                            <td class="align-middle">
                                ...
                                <a id="GFG" href="/deleteParticipant2/${i.id}/${trip.id}">Remove</a>
                                  </c:if>
                            </td>                 
                        </tr>
                 		</c:if>
                    ...
                    <table class="table-right table table-striped table-light">
                        ...
                        <c:if test="${user.myFriends.contains(i)}">
                            ...
                            <td class="align-middle">
                            <form:form action="/addToTrip/${i.id}/${trip.id}" method="post" modelAttribute="addToTrip">
            ...
            <a href="/trip/${trip.id}"><button type="submit">Create</button></a>
        <div class="img"></div> 
        </c:if>
</body>
<footer class="mt-5">
