...
public class UserService {
    ...
    public List<User> findByNotOnTrip(Trip trip) {
    	return userRepo.findByParticipatingNotContains(trip);
    }
    
    public List<User> NotParticipatingOrFriend(Trip trip, User user){
    	return userRepo.findByParticipatingOrMyFriendsNotContains(trip, user);
    }
